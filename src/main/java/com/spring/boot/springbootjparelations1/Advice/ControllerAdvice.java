package com.spring.boot.springbootjparelations1.Advice;

import com.spring.boot.springbootjparelations1.Api.ApiException;
import com.spring.boot.springbootjparelations1.Api.ApiResponse;
...
public class ControllerAdvice {
    ...
    // when entering other than JSON format from the user:
    ...
    // no end point defined as requested by the user
    ...
    // the end point is there, but the HTTP method is not found
    ...
    // different signature entered by the user, for example integer instead of string
    ...
    // above are found by me: 7 Exceptions

    // Others from the README file:
    // Server Validation Exception
